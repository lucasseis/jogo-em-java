...
function draw() {
  ...
  if (mouseIsPressed || touches.length > 0 || keyIsPressed) {
    ...
    if (tempo > 400) {
      image(farra1, 20, CADEIRAS_Y, 100, 160, 180, 100, 450, 720);
    } else {
      image(farra2, 20, CADEIRAS_Y, 100, 160, 180, 100, 450, 720);
    }
    ...
    tempo = millis() % 900;
    if (tempo > 450) {
      image(farra1, 290, CADEIRAS_Y, 100, 160, 180, 100, 450, 720);
    } else {
      image(farra2, 290, CADEIRAS_Y, 100, 160, 180, 100, 450, 720);
    }
 ...
 // Alunos lado a lado
    image(quieto, 20, CADEIRAS_Y, 100, 160, 180, 100, 450, 720);
    image(quieto, 150, CADEIRAS_Y, 100, 160, 180, 100, 450, 720);
    image(quieto, 290, CADEIRAS_Y, 100, 160, 180, 100, 450, 720);
  }
}